...
alias cbfeat="node $CLAUDE_CUSTOM_DIR/commands/feature-sync.js"
...
echo "  - cbfeat  : Append concise progress/context to a feature notes file (optional arg: feature filename)"
